*** Settings ***
Suite Teardown  Executa após todos os casos de teste da suite
Test Teardown   Executa após a execução de cada caso de teste individualmente

*** Test Cases ***

#### Casos de Teste com sucesso
CT001: Teste lidando com Suite e Test Teardowns
...
CT002: Teste lidando com Suite e Test Teardowns
    Esse keyword vai passar sozinha!
    Esse keyword vai passar sozinha!
...
CT003: Teste lidando com Suite e Test Teardowns
    Esse keyword vai passar sozinha!
    Essa keyword fará o teste falhar, não executando as keywords abaixo!
    Esse keyword vai passar sozinha!
    Esse keyword vai falhar sozinha!

CT004: Teste lidando com Suite e Test Teardowns
    Esse keyword vai falhar sozinha!

*** Keywords ***

### SUITE TEARDOWNS
Executa após todos os casos de teste da suite
...
### TEST TEARDOWNS
Executa após a execução de cada caso de teste individualmente
...
### Controlando o conteudo da variável STATUS
Esse aqui também vai passar com uma condição e vai parar de executar as keywords abaixo!
