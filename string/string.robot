...
...     ${STRING}: Utilizado para armazenar o arquivo em formato de string
...    Get Line Count: Conta as linhas do arquivo string
...    Get Line: Pega um arquivo pela sua linha especifica
...    Get Lines Containing String: Pega o arquivo com base na string existente
...    Fetch From Left: Pega o arquivo até um marcador especifico, contado da esquerda para a direita
...    Fetch From Right: Pega o arquivo até um marcador especifico, contado da direita para a esquerda
...    Convert To Lowercase: Converte para um texto maiúsculo
...    Convert To Uppercase: Converte para um texto minúsculo

Library         String
Library         OperatingSystem

*** Test Cases ***
CT001: Lidando com linhas de um texto String
    Contando as linhas
    Pegando uma linha específica
    Pegando uma linha específica com a palavra "linha 01"
    Pegando até um marcador

CT002: Manipulando a String
...
Pega arquivo
    ...
    ${CONTEUDO_ARQUIVO}    Get File    ./my-files/arquivo_texto_linhas.txt
...
Substituindo valores no texto
    ...
    Create File     ./my-files/meu_novo_arquivo.txt      ${NOVO_TEXTO}
